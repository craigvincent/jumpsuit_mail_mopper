...
namespace GmailCleanup.Services
{
    public class GmailFetchService
    {
            ...
            CancellationToken ct)
        {
            ...
            try
            {
                do
                {
                    ...
                    historyRequest.StartHistoryId = ulong.Parse(lastSync.LastHistoryId);
                    if (pageToken != null)
        ...
        private EmailRecord ParseEmailRecord(Message message)
        {
        ...
        private string ExtractEmailDomain(string fromHeader)
        {
        ...
        private string ExtractCategory(IList<string>? labelIds)
        {
